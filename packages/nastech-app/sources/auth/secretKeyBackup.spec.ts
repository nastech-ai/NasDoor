...
describe.skip("secretKeyBackup", () => {
  ...
  describe("parseBackupSecretKey", () => {
    ...
    it("should throw error for invalid characters", () => {
      ...
      expect(() => parseBackupSecretKey("!!!INVALID!!!")).toThrow(
        "Invalid key length",
      );
    });

    it("should throw error for wrong length", () => {
      expect(() => parseBackupSecretKey("AAAAA-BBBBB")).toThrow(
        "Invalid key length",
      );
    });
  ...
  describe("isValidSecretKey", () => {
    ...
    it("should reject malformed formatted keys", () => {
      ...
      expect(
        isValidSecretKey("AAAAA-BBBBB-CCCCC-DDDDD-EEEEE-FFFFF-GGGGG-HHHHH"),
      ).toBe(false);
    });
  });
  ...
  describe("Robustness - Special characters and noise", () => {
    ...
    it("should handle HTML entities", () => {
      ...
      expect(() => parseBackupSecretKey(withEntities)).toThrow(
        /Invalid key length/,
      );
    });
    ...
    it("should handle URL encoding artifacts", () => {
      ...
      expect(() => parseBackupSecretKey(withPercents)).toThrow(
        /Invalid key length/,
      );
    });
  ...
  describe("Robustness - Error messages should be helpful", () => {
    it("should give clear error for empty input", () => {
      expect(() => parseBackupSecretKey("")).toThrow(
