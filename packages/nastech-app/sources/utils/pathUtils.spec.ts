...
describe("pathUtils", () => {
  describe("resolveAbsolutePath", () => {
    describe("basic tilde expansion", () => {
      ...
      it("should expand ~/Documents to home directory plus path", () => {
        expect(resolveAbsolutePath("~/Documents", "/Users/steve")).toBe(
          "/Users/steve/Documents",
        );
      });

      it("should expand ~/Documents/project to nested path", () => {
        expect(resolveAbsolutePath("~/Documents/project", "/Users/steve")).toBe(
          "/Users/steve/Documents/project",
        );
      });

      it("should expand ~/Documents/deep/nested/path", () => {
        expect(
          resolveAbsolutePath("~/Documents/deep/nested/path", "/Users/steve"),
        ).toBe("/Users/steve/Documents/deep/nested/path");
      });
    });

    describe("non-tilde paths remain unchanged", () => {
      it("should not modify absolute Unix paths", () => {
        expect(resolveAbsolutePath("/usr/local/bin", "/Users/steve")).toBe(
          "/usr/local/bin",
        );
      });
      ...
      it("should not modify absolute Windows paths", () => {
        expect(
          resolveAbsolutePath("C:\\Program Files", "C:\\Users\\steve"),
        ).toBe("C:\\Program Files");
      });

      it("should not modify relative paths", () => {
        expect(resolveAbsolutePath("./folder", "/Users/steve")).toBe(
          "./folder",
        );
        expect(resolveAbsolutePath("../parent", "/Users/steve")).toBe(
          "../parent",
        );
        expect(resolveAbsolutePath("relative/path", "/Users/steve")).toBe(
          "relative/path",
        );
      });
      ...
      it("should not modify paths starting with ~username (other user homes)", () => {
        ...
        expect(resolveAbsolutePath("~john/Documents", "/Users/steve")).toBe(
          "~john/Documents",
        );
      });
    });
    ...
    describe("Windows path handling", () => {
      it("should expand ~ with Windows home directory", () => {
        expect(resolveAbsolutePath("~", "C:\\Users\\steve")).toBe(
          "C:\\Users\\steve",
        );
      });
      ...
      it("should use Windows separator for Windows home", () => {
        ...
        expect(
          resolveAbsolutePath("~/Documents/project", "C:\\Users\\steve"),
        ).toBe("C:\\Users\\steve\\Documents/project");
      });
    ...
    describe("edge cases", () => {
      it("should return original path when homeDir is undefined", () => {
        ...
        expect(resolveAbsolutePath("~/Documents", undefined)).toBe(
          "~/Documents",
        );
      });
      ...
      it("should handle paths with spaces", () => {
        expect(resolveAbsolutePath("~/My Documents", "/Users/steve")).toBe(
          "/Users/steve/My Documents",
        );
        expect(
          resolveAbsolutePath("~/Program Files/My App", "C:\\Users\\steve"),
        ).toBe("C:\\Users\\steve\\Program Files/My App");
      });

      it("should handle paths with special characters", () => {
        expect(resolveAbsolutePath("~/Documents & Files", "/Users/steve")).toBe(
          "/Users/steve/Documents & Files",
        );
        expect(
          resolveAbsolutePath("~/folder@example.com", "/Users/steve"),
        ).toBe("/Users/steve/folder@example.com");
      });
    });
    ...
    describe("path separator normalization", () => {
      it("should use Unix separator for Unix home paths", () => {
        ...
        expect(
          resolveAbsolutePath("~/Documents/subfolder", "/Users/steve"),
        ).toBe("/Users/steve/Documents/subfolder");
      });

      it("should use Windows separator for Windows home paths", () => {
        expect(
          resolveAbsolutePath("~/Documents/subfolder", "C:\\Users\\steve"),
        ).toBe("C:\\Users\\steve\\Documents/subfolder");
      });
    ...
    describe("long paths", () => {
      it("should handle very long paths", () => {
        ...
        expect(result).toBe(
          "/Users/steve/Documents/" + "a".repeat(200) + "/file.txt",
        );
      });

      it("should handle very long home directory paths", () => {
        const longHome =
          "/very/long/path/to/users/" + "b".repeat(100) + "/steve";
        expect(resolveAbsolutePath("~/Documents", longHome)).toBe(
          longHome + "/Documents",
        );
      });
    });
  ...
  describe("resolvePath (existing function)", () => {
    ...
    it("should resolve path relative to metadata root", () => {
      ...
      expect(resolvePath("/Users/steve/project/src/file.ts", metadata)).toBe(
        "src/file.ts",
      );
    });
    ...
    it("should return original path if not under metadata path", () => {
      ...
      expect(resolvePath("/usr/local/bin/node", metadata)).toBe(
        "/usr/local/bin/node",
      );
    });
    ...
    it("should not resolve sibling directory paths that start with metadata path", () => {
      ...
      expect(
        resolvePath(
          "/Users/steve/Develop/nastech-ai/nastech-server/sources/types/index.ts",
          metadata,
        ),
      ).toBe(
        "/Users/steve/Develop/nastech-ai/nastech-server/sources/types/index.ts",
  ...
  describe("integration scenarios", () => {
    it("should work with typical macOS home directories", () => {
      ...
      expect(resolveAbsolutePath("~/Projects/nastech", homeDir)).toBe(
        "/Users/developer/Projects/nastech",
      );
    ...
    it("should work with typical Linux home directories", () => {
      ...
      expect(resolveAbsolutePath("~/projects/nastech", homeDir)).toBe(
        "/home/developer/projects/nastech",
      );
    ...
    it("should work with typical Windows home directories", () => {
      ...
      expect(resolveAbsolutePath("~/Projects/nastech", homeDir)).toBe(
        "C:\Users\developer\Projects/nastech",
      );
      expect(resolveAbsolutePath("~/Desktop/file.txt", homeDir)).toBe(
    ...
    it("should handle common session creation scenarios", () => {
      ...
      expect(resolveAbsolutePath("~/Code", macHomeDir)).toBe(
        "/Users/steve/Code",
      );
      expect(resolveAbsolutePath("~/Documents/Projects", macHomeDir)).toBe(
        "/Users/steve/Documents/Projects",
      );
      expect(resolveAbsolutePath("/absolute/path", macHomeDir)).toBe(
        "/absolute/path",
      );
