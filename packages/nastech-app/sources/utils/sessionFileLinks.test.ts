...
describe("sessionFileLinks", () => {
  ...
  it("parses absolute file refs with line numbers", () => {
    const result = parseSessionFileLink(
      "/Users/kirilldubovitskiy/projects/nastech/packages/nastech-cli/src/codex/runCodex.ts:594",
      {
        sessionRoot,
      },
    );
    ...
    expect(result).toEqual({
      ...
      absolutePath:
        "/Users/kirilldubovitskiy/projects/nastech/packages/nastech-cli/src/codex/runCodex.ts",
  ...
  it("parses relative file refs with line and column numbers", () => {
    const result = parseSessionFileLink(
      "packages/nastech-cli/src/codex/runCodex.ts:594:2",
      {
        sessionRoot,
      },
    );
  ...
  it("rejects external urls", () => {
    expect(
      parseSessionFileLink("https://openai.com", { sessionRoot }),
    ).toBeNull();
    expect(
      parseSessionFileLink("mailto:test@example.com", { sessionRoot }),
    ).toBeNull();
  });

  it("splits bare text into plain and linked segments", () => {
    const result = splitSessionFileText(
      "Open packages/nastech-cli/src/codex/runCodex.ts:594 please.",
      sessionRoot,
    );
    ...
    expect(result).toEqual([
      { text: "Image: ", link: null },
      {
        ...
        link: {
          ...
          absolutePath:
            "/Users/kirilldubovitskiy/Library/Application Support/CleanShot/media/test/CleanShot 2026-03-19 at 00.54.37@2x.png",
          relativePath: null,
  ...
  it("resolves viewer input to an absolute path", () => {
    expect(
      resolveSessionFilePath("packages/nastech-app/README.md", sessionRoot),
    ).toEqual({
      path: "packages/nastech-app/README.md",
      absolutePath:
        "/Users/kirilldubovitskiy/projects/nastech/packages/nastech-app/README.md",
