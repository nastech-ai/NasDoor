...
export const es: TranslationStructure = {
  ...
  settings: {
    ...
    showOfflineMachines: ({ count }: { count: number }) =>
      count === 1
        ? "Mostrar 1 máquina sin conexión"
        : `Mostrar ${count} máquinas sin conexión`,
    ...
    about: "Acerca de",
    aboutFooter:
      "NasTech es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.",
    whatsNew: "Novedades",
  ...
  settingsAppearance: {
    ...
    diffStyleDescription:
      "Mostrar diferencias en una sola columna (unified) o lado a lado (split). La vista split solo funciona en web.",
    diffStyleOptions: {
      unified: "Unified",
      split: "Split",
    },
    ...
    zenMode: "Modo Zen",
    zenModeDescription:
      "Oculta elementos de la interfaz para una experiencia sin distracciones",
  ...
  settingsFeatures: {
    ...
    groupToolCallsSubtitle:
      "Contrae las llamadas consecutivas a herramientas en un solo contenedor",
    privacy: "Privacidad",
    privacyDescription:
      "Desactiva completamente toda la analítica y telemetría. No se enviarán datos a PostHog ni a ningún otro servicio de seguimiento.",
    ...
    imageUploadSubtitle:
      "Adjunta imágenes a los mensajes para que Claude las analice",
  },
  ...
  errors: {
    ...
    voiceHardLimitReached: ({ hours }: { hours: number }) =>
      `Has usado ${hours}+ horas de voz este mes. Este es el máximo permitido. Puedes configurar tu propio agente ElevenLabs en la configuración de voz para usar tu propia cuota.`,
    voiceConversationLimitReached:
      "Has alcanzado el número máximo de conversaciones de voz este mes. Es posible que en el futuro agreguemos uso de voz bajo demanda — por favor crea un issue en github.com/nastech-ai/nastech/issues si alcanzas este límite.",
  ...
  newSession: {
    ...
    switchMachinesHint:
      "• Cambia de máquina haciendo clic en la máquina de arriba",
  },
  ...
  session: {
    ...
    duplicateSheetSubtitle:
      "La nueva sesión conservará el turno elegido completo (tu mensaje y la respuesta del agente) y descartará los siguientes mensajes.",
    duplicateSheetConfirm: "Duplicar",
    duplicateSheetEmpty:
      "Aún no hay mensajes elegibles para retroceder en esta sesión.",
    duplicateRowDisabled:
      "Este mensaje no se puede usar como punto de retroceso.",
    forkedFromLabel: "Bifurcado de",
    forkedFromSubtitle: "Abrir la sesión de la que se bifurcó",
    forkErrorOffline:
      "Esta máquina está fuera de línea. Bifurcar solo está disponible mientras la máquina de la sesión esté en línea.",
    forkErrorMissingUuid:
      "El punto de retroceso elegido ya no existe en la sesión origen — intenta bifurcar sin truncar.",
    forkErrorMissingMetadata:
      "Faltan metadatos de la sesión necesarios para bifurcar.",
    forkErrorGeneric: "No se pudo bifurcar la sesión.",
    forkClaudeOnly:
      "La bifurcación actualmente solo se admite para sesiones de Claude.",
  },
  ...
  sessionInfo: {
    ...
    worktreeCleanupMessage:
      "El Worktree no tiene cambios sin confirmar. ¿Deseas eliminar los archivos del Worktree?",
  ...
  toolGroup: {
    editedFiles: ({ count }: { count: number }) =>
      count === 1 ? "Se editó 1 archivo" : `Se editaron ${count} archivos`,
    readFiles: ({ count }: { count: number }) =>
      count === 1 ? "Se leyó 1 archivo" : `Se leyeron ${count} archivos`,
    ranCommands: ({ count }: { count: number }) =>
      count === 1 ? "Se ejecutó 1 comando" : `Se ejecutaron ${count} comandos`,
    searched: ({ count }: { count: number }) =>
      count === 1 ? "Se buscó 1 vez" : `Se buscó ${count} veces`,
    fetchedUrls: ({ count }: { count: number }) =>
      count === 1 ? "Se obtuvo 1 URL" : `Se obtuvieron ${count} URLs`,
    ranTasks: ({ count }: { count: number }) =>
      count === 1 ? "Se ejecutó 1 tarea" : `Se ejecutaron ${count} tareas`,
    usedTools: ({ count }: { count: number }) =>
      count === 1 ? "Se usó 1 herramienta" : `Se usaron ${count} herramientas`,
  },
  ...
  files: {
    ...
    fileConflictDescription:
      "Este archivo fue modificado en el dispositivo mientras lo editabas. Recarga para ver la última versión.",
    reload: "Recargar",
  ...
  terminal: {
    ...
    terminalRequestDescription:
      "Un terminal está solicitando conectarse a tu cuenta de NasTech. Esto permitirá al terminal enviar y recibir mensajes de forma segura.",
  ...
  machine: {
    ...
    deleteFooter:
      "Elimina esta máquina de tu cuenta. El historial de sesiones se conservará, pero no podrás iniciar nuevas sesiones en esta máquina.",
    deleteConfirmTitle: "¿Eliminar esta máquina?",
    deleteConfirmMessage:
      "La máquina se eliminará de tu cuenta. El historial de sesiones se conservará, pero no podrás iniciar nuevas sesiones hasta que vuelvas a conectar el daemon.",
  ...
  imageUpload: {
    ...
    permissionMessage:
      "Permite el acceso a tu biblioteca de fotos para adjuntar imágenes a los mensajes.",
    limitTitle: "Límite de imágenes alcanzado",
    limitMessage: ({ max }: { max: number }) =>
      `Puedes adjuntar hasta ${max} imágenes por mensaje.`,
    fileTooLargeTitle: "Archivo demasiado grande",
    fileTooLargeMessage: ({ name, maxMb }: { name: string; maxMb: number }) =>
      `"${name}" supera el límite de ${maxMb}MB y no se añadió.`,
    ...
    notSupportedMessage:
      "Este agente no admite imágenes adjuntas. Solo se envió el texto.",
  },
