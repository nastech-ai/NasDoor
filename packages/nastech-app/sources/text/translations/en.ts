...
export const en: TranslationStructure = {
  ...
  settings: {
    ...
    showOfflineMachines: ({ count }: { count: number }) =>
      count === 1 ? "Show 1 offline machine" : `Show ${count} offline machines`,
    ...
    about: "About",
    aboutFooter:
      "NasTech is a Codex and Claude Code mobile client. It's fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.",
    whatsNew: "What's New",
  ...
  settingsAppearance: {
    ...
    diffStyleDescription:
      "Show diffs as a single column (unified) or side-by-side (split). Split view is web-only.",
    diffStyleOptions: {
      unified: "Unified",
      split: "Split",
    },
  ...
  settingsFeatures: {
    ...
    groupToolCallsSubtitle:
      "Collapse consecutive tool calls into one container",
    privacy: "Privacy",
    privacyDescription:
      "Completely disables all analytics and telemetry. No data will be sent to PostHog or any other tracking service.",
  ...
  errors: {
    ...
    voiceHardLimitReached: ({ hours }: { hours: number }) =>
      `You've used ${hours}+ hours of voice this month. This is the maximum allowed. You can configure your own ElevenLabs agent in Voice settings to use your own quota.`,
    voiceConversationLimitReached:
      "You've reached the maximum number of voice conversations this month. We may add on-demand voice usage in the future — please file an issue at github.com/nastech-ai/nastech/issues if you hit this limit.",
  ...
  session: {
    ...
    duplicateSheetSubtitle:
      "The new session keeps the chosen turn complete (your message and the agent’s response) and drops every prompt after it.",
    ...
    forkErrorOffline:
      "This machine is offline. Fork is only available while the machine that owns the session is online.",
  ...
  sessionInfo: {
    ...
    worktreeCleanupMessage:
      "The worktree has no uncommitted changes. Would you like to delete the worktree files?",
  ...
  toolGroup: {
    editedFiles: ({ count }: { count: number }) =>
      count === 1 ? "Edited 1 file" : `Edited ${count} files`,
    ...
    searched: ({ count }: { count: number }) =>
      count === 1 ? "Searched 1 time" : `Searched ${count} times`,
    fetchedUrls: ({ count }: { count: number }) =>
      count === 1 ? "Fetched 1 URL" : `Fetched ${count} URLs`,
    ranTasks: ({ count }: { count: number }) =>
      count === 1 ? "Ran 1 task" : `Ran ${count} tasks`,
  ...
  files: {
    ...
    fileConflictDescription:
      "This file was modified on the device while you were editing. Reload to see the latest version.",
    reload: "Reload",
    overwrite: "Overwrite",
  },
  ...
  settingsVoice: {
    ...
    customAgentIdDescription:
      "Enter your ElevenLabs agent ID. Leave empty to use the NasTech default.",
  ...
  terminal: {
    ...
    terminalRequestDescription:
      "A terminal is requesting to connect to your NasTech account. This will allow the terminal to send and receive messages securely.",
  ...
  machine: {
    ...
    deleteFooter:
      "Removes this machine from your account. Session history is preserved, but you will no longer be able to launch new sessions on it.",
    deleteConfirmTitle: "Delete this machine?",
    deleteConfirmMessage:
      "This removes the machine from your account. Session history is preserved, but you can no longer launch new sessions on it until you reconnect the daemon.",
  ...
  imageUpload: {
    ...
    permissionMessage:
      "Allow access to your photo library to attach images to messages.",
    limitTitle: "Image Limit Reached",
    limitMessage: ({ max }: { max: number }) =>
      `You can attach up to ${max} images per message.`,
    fileTooLargeTitle: "File Too Large",
    fileTooLargeMessage: ({ name, maxMb }: { name: string; maxMb: number }) =>
      `"${name}" exceeds the ${maxMb}MB limit and was not added.`,
    ...
    notSupportedMessage:
      "This agent does not support image attachments. Only the text was sent.",
  },
