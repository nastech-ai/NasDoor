...
export const en = {
  ...
  machine: {
    ...
    deleteConfirmMessage:
      "The machine will be removed from your account. Session history will be preserved, but you will not be able to start new sessions until you reconnect the daemon.",
    ...
    readonly [P in keyof Translations[K]]: Translations[K][P] extends string
      ...
      : Translations[K][P] extends (...args: any[]) => string
        ...
        : Translations[K][P] extends object
          ? {
              readonly [
                Q in keyof Translations[K][P]
              ]: Translations[K][P][Q] extends string
                ? string
                : Translations[K][P][Q];
            }
          : Translations[K][P];
