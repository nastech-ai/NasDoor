...
const ColorSwatch = ({
  ...
  <View style={styles.swatchContainer}>
    <View style={[styles.swatch, { backgroundColor: color }]}>
      <Text style={{ color: textColor, ...Typography.default("semiBold") }}>
        {name}
      </Text>
      <Text style={{ color: textColor, ...Typography.mono(), fontSize: 12 }}>
        {color}
      </Text>
    </View>
  </View>
...
const ColorPair = ({
  ...
  <View style={styles.swatchContainer}>
    <View style={[styles.swatch, { backgroundColor: bg }]}>
      ...
      <Text style={{ color: text, ...Typography.mono(), fontSize: 12 }}>
        BG: {bg}
      </Text>
      <Text style={{ color: text, ...Typography.mono(), fontSize: 12 }}>
        Text: {text}
