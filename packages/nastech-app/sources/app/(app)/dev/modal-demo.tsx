...
function CustomContentModal({
  ...
  return (
    <View style={styles.customModal}>
      <Text style={[styles.customModalTitle, Typography.default("semiBold")]}>
        {title}
      </Text>
      <Text style={[styles.customModalMessage, Typography.default()]}>
        {message}
      </Text>
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={[styles.subtitle, Typography.default()]}>
          ...
          {Platform.OS === "web" ? "Custom modals" : "Native alerts"})
        </Text>
      </View>
