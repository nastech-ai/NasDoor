...
export default function UnistylesDemo() {
  ...
  const toggleColorScheme = () => {
    ...
    console.log(
      "Color scheme toggle requested - this would typically be system controlled",
    );
  };
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.breakpointBox}>
            ...
            <Text
              style={[styles.breakpointText, { fontSize: 12, opacity: 0.8 }]}
            >
        ...
        <View style={styles.section}>
          ...
          {["Tiny", "Small", "Medium", "Large", "Extra Large"].map(
            (size, index) => (
        ...
        <View style={styles.section}>
          ...
          <View
            style={{
              backgroundColor:
                rt.colorScheme === "dark" ? "#2C3E50" : "#ECF0F1",
              padding: 16,
              borderRadius: 8,
            }}
          >
        ...
        >
          <Text style={[styles.sectionTitle, { color: "#856404" }]}>
            ⚡ Performance Note
          </Text>
          <Text style={{ color: "#856404", lineHeight: 20 }}>
            Unistyles compiles styles at build time and provides runtime
            optimizations. All the responsive features you see here work without
            performance penalties thanks to the native bridge integration.
          </Text>
        </View>
      </ScrollView>
    </View>
