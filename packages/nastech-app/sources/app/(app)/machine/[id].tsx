  ...
  const handleDeleteMachine = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        Modal.alert(
          t("common.error"),
          result.message || t("machine.deleteFailed"),
        );
      }
    } catch (error) {
      Modal.alert(
  ...
  return (
    <>
      ...
      >
          ...
          <ItemGroup title={t("machine.cliAvailability")}>
            <Item
              ...
              rightElement={
                <Text
                  style={{
                    color: metadata.cliAvailability.claude
                      ? "#34C759"
                      : theme.colors.textSecondary,
                    fontSize: 14,
                  }}
                >
                  {metadata.cliAvailability.claude
                    ? t("machine.cliInstalled")
                    : t("machine.cliNotFound")}
                </Text>
              }
            />
            <Item
              ...
              rightElement={
                <Text
                  style={{
                    color: metadata.cliAvailability.codex
                      ? "#34C759"
                      : theme.colors.textSecondary,
                    fontSize: 14,
                  }}
            ...
            <Item
              ...
              rightElement={
                <Text
                  style={{
                    color: metadata.cliAvailability.gemini
                      ? "#34C759"
                      : theme.colors.textSecondary,
                    fontSize: 14,
                  }}
                >
                  {metadata.cliAvailability.gemini
                    ? t("machine.cliInstalled")
                    : t("machine.cliNotFound")}
                </Text>
              }
            ...
            <Item
              ...
              rightElement={
                <Text
                  style={{
                    color: metadata.cliAvailability.openclaw
                      ? "#34C759"
                      : theme.colors.textSecondary,
                    fontSize: 14,
                  }}
                >
                  {metadata.cliAvailability.openclaw
                    ? t("machine.cliInstalled")
                    : t("machine.cliNotFound")}
                </Text>
              }
            ...
            <Item
              ...
              subtitle={new Date(
                metadata.cliAvailability.detectedAt,
              ).toLocaleString()}
              showChevron={false}
            />
          </ItemGroup>
        ...
        {/* Danger zone */}
        <ItemGroup
          title={t("machine.dangerZone")}
          footer={t("machine.deleteFooter")}
        >
          <Item
