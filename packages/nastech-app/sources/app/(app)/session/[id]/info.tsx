        ...
        <ItemGroup title={t("sessionInfo.quickActions")}>
          ...
          {canFork && (
            <Item
              ...
              icon={
                <Ionicons name="git-branch-outline" size={29} color="#007AFF" />
              }
              onPress={forkSession}
              loading={forking}
            />
          ...
          {session.metadata?.parentSessionId && (
            <Item
              ...
              onPress={() =>
                router.push(`/session/${session.metadata!.parentSessionId}`)
              }
            />
          )}
          <Item
        ...
        {session.metadata && (
          <ItemGroup title={t("sessionInfo.metadata")}>
            ...
            <Item
              ...
              icon={
                <Ionicons name="shield-outline" size={29} color="#5856D6" />
              }
              showChevron={false}
            />
            <Item
              ...
              icon={
                <Ionicons name="warning-outline" size={29} color="#5856D6" />
              }
              showChevron={false}
            />
