...
export default function FeaturesSettingsScreen() {
  ...
  const [expResumeSession, setExpResumeSession] =
    useSettingMutable("expResumeSession");
  const [fileDiffsSidebar, setFileDiffsSidebar] =
    useSettingMutable("fileDiffsSidebar");
  const [groupToolCalls, setGroupToolCalls] =
    useSettingMutable("groupToolCalls");
  const [expImageUpload, setExpImageUpload] =
    useSettingMutable("expImageUpload");
    ...
    <ItemList style={{ paddingTop: 0 }}>
      ...
      >
        <Item
          ...
          icon={
            <Ionicons name="git-branch-outline" size={29} color="#5AC8FA" />
          }
          rightElement={
            <Switch
        ...
        <Item
          ...
          rightElement={
            <Switch value={groupToolCalls} onValueChange={setGroupToolCalls} />
          }
          showChevron={false}
        />
      </ItemGroup>
      ...
      >
        ...
        <Item
          ...
          icon={
            <Ionicons name="play-circle-outline" size={29} color="#30D158" />
          }
          rightElement={
            <Switch
      ...
      >
        <Item
          ...
          subtitle={
            analyticsOptOut
              ? t("settingsFeatures.analyticsDisabled")
              : t("settingsFeatures.analyticsEnabled")
          }
