...
export default function UserProfileScreen() {
  ...
  const [addingFriend, addFriend] = useNasTechAction(async () => {
  ...
  const [removingFriend, handleRemoveFriend] = useNasTechAction(async () => {
    if (!credentials || !userProfile) return;
        ...
        return [
          {
            ...
            icon: (
              <Ionicons name="person-add-outline" size={29} color="#007AFF" />
            ),
            onPress: addFriend,
            loading: addingFriend,
          },
    ...
    <ItemList style={{ paddingTop: 0 }}>
      ...
      <ItemGroup>
        <Item
          ...
          onPress={() =>
            openExternalUrl(`https://github.com/${userProfile.username}`)
          }
        />
      </ItemGroup>
