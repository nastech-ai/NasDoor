...
export const MultiTextInput = React.memo(
  React.forwardRef<MultiTextInputHandle, MultiTextInputProps>((props, ref) => {
    const {
      value,
      defaultValue,
      onChangeText,
    ...
    const [uncontrolledText, setUncontrolledText] = React.useState<string>(
      defaultValue ?? "",
    );
