...
function getBuildConfig(): BuildConfig {
  ...
  return appConfig && typeof appConfig === "object"
    ? (appConfig as BuildConfig)
    : {};
}
...
function formatBuildSubtitle(buildConfig: BuildConfig): string | undefined {
  const commitTimestamp =
    typeof buildConfig.buildCommitTimestamp === "string"
      ? formatUtcTimestamp(buildConfig.buildCommitTimestamp)
      : undefined;
  const commitSha =
    typeof buildConfig.buildCommitSha === "string"
...
export const SettingsView = React.memo(function SettingsView() {
  ...
  const [disconnectingGitHub, handleDisconnectGitHub] = useNasTechAction(
    async () => {
  ...
  const [disconnectingAnthropic, handleDisconnectAnthropic] = useNasTechAction(
    async () => {
      const confirmed = await Modal.confirm(
    ...
    <ItemList style={{ paddingTop: 0 }}>
      ...
      <ItemGroup>
        <Item
          ...
          subtitle={
            isPro
              ? t("settings.supportUsSubtitlePro")
              : t("settings.supportUsSubtitle")
          }
            ...
            <Item
              title={
                showOfflineMachines
                  ...
                  : t("settings.showOfflineMachines", {
      ...
      <ItemGroup title={t("settings.features")}>
        <Item
          ...
          icon={
            <Ionicons name="person-circle-outline" size={29} color="#007AFF" />
          }
        ...
        <Item
          ...
          icon={
            <Ionicons name="color-palette-outline" size={29} color="#5856D6" />
          }
        ...
        {experiments && (
          <Item
            ...
            icon={
              <Ionicons name="analytics-outline" size={29} color="#007AFF" />
            }
      ...
      {(__DEV__ || devModeEnabled) && (
        <ItemGroup title={t("settings.developer")}>
          <Item
            ...
            icon={
              <Ionicons name="construct-outline" size={29} color="#5856D6" />
            }
      ...
      <ItemGroup title={t("settings.about")} footer={t("settings.aboutFooter")}>
        ...
        <Item
          title={t("settings.github")}
          icon={
            <Ionicons name="logo-github" size={29} color={theme.colors.text} />
          }
        ...
        <Item
          ...
          onPress={() =>
            openExternalUrl(
              "https://github.com/nastech-ai/nastech/blob/main/TERMS.md",
            )
          }
        />
        {Platform.OS === "ios" && (
