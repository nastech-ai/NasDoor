...
function useNavHistory() {
  ...
  const markBack = React.useCallback(() => {
    directionRef.current = "back";
  }, []);
  const markForward = React.useCallback(() => {
...
export const SidebarNavigator = React.memo(() => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {isDesktopLayout && <PersistentHeader />}
    </View>
  );
});
      ...
      >
        ...
        >
          <Image
            ...
            tintColor={
              zenMode ? theme.colors.textLink : theme.colors.header.tint
            }
          />
        </Pressable>
        <Pressable
          ...
          style={{
            ...
            alignItems: "center",
            justifyContent: "center",
            opacity: canGoBackEffective ? 1 : 0.3,
          }}
        >
          <Ionicons
            name="chevron-back"
        ...
        {Platform.OS === "web" && (
          <Pressable
            ...
            style={{
              ...
              alignItems: "center",
              justifyContent: "center",
              opacity: canGoForwardEffective ? 1 : 0.3,
            }}
          >
            <Ionicons
