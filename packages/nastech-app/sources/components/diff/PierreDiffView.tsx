...
export const PierreDiffView = React.memo(function PierreDiffView(
  props: PierreDiffViewProps,
) {
  if (Platform.OS === "web") {
...
const PierreDiffViewWeb = React.memo(function PierreDiffViewWeb(
  props: PierreDiffViewProps,
) {
  ...
  const diffsTheme =
    themeName === "dark" ? "github-dark-default" : "github-light-default";
...
const PierreDiffViewNative = React.memo(function PierreDiffViewNative(
  props: PierreDiffViewProps,
) {
  if (props.patch) {
    return (
