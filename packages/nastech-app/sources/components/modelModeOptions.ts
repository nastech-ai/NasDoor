...
export function getGeminiPermissionModes(
  ...
  return [
    ...
    {
      key: "auto_edit",
      name: translate("agentInput.geminiPermissionMode.autoEdit"),
      description: null,
    },
    {
      key: "yolo",
    ...
    {
      key: "plan",
      name: translate("agentInput.geminiPermissionMode.plan"),
      description: null,
    },
  ];
}
...
export function getOpenClawPermissionModes(
  translate: Translate,
): PermissionMode[] {
  return [
    {
...
export function getAvailableModels(
  ...
  if (metadataModels.length > 0) {
    if (
      flavor === "codex" &&
      !metadataModels.some((model) => model.key === "default")
    ) {
      return [
        { key: "default", name: "default model", description: null },
        ...metadataModels,
...
export function getDefaultEffortKeyForModel(
  ...
  return (
    getCodeAgentDefaults(flavor).effortLevel ?? levels[levels.length - 1].key
  );
}
