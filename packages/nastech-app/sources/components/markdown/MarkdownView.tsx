    ...
    <View style={{ flexDirection: "column", marginBottom: 8, gap: 6 }}>
      {props.items.map((item, index) => (
        ...
        >
          <Text
            selectable={false}
            style={[listStyle, { marginRight: 8, marginTop: 1 }]}
          >
    ...
    >
      ...
      <View
        style={[
          ...
          isHovered && style.copyButtonWrapperVisible,
        ]}
        {...(Platform.OS === "web"
          ...
          return (
            <Text
              ...
              {...(isExternalLink && Platform.OS === "web"
                ? ({ onClick: () => props.onLinkPress(span.url!) } as any)
                : {})}
              onPress={
                isExternalLink && Platform.OS !== "web"
  ...
  const columnWidths = React.useMemo(() => {
    ...
    return widths.map((len) =>
      Math.min(
        ...
        Math.max(
          TABLE_MIN_COL_WIDTH,
          len * TABLE_CHAR_WIDTH + TABLE_CELL_H_PADDING,
        ),
      ),
    );
            ...
            {props.headers.map((header, colIndex) => (
              <View
                ...
                style={[
                  ...
                  !isLastCol(colIndex) && style.tableCellBorderRight,
                ]}
              >
