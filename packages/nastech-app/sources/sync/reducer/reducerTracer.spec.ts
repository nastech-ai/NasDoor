...
describe("reducerTracer", () => {
  ...
  describe("traceMessages", () => {
    it("should return non-sidechain messages immediately", () => {
      ...
      const messages: NormalizedMessage[] = [
        ...
        },
        {
          ...
          isSidechain: false,
          content: [
            { type: "text", text: "Hi there", uuid: "uuid1", parentUUID: null },
          ],
        },
      ];
    ...
    it("should identify and track Agent tools", () => {
      ...
      expect(state.promptToTaskId.get("Inspect translations")).toBe(
        "msg-agent",
      );
    });
    ...
    it("should buffer orphan messages until parent arrives", () => {
      ...
      expect(
        state.orphanMessages.has("11111111-1111-4111-8111-111111111111"),
      ).toBe(true);
    ...
    it("should handle recursive orphan processing", () => {
      ...
      expect(
        state.orphanMessages.has("22222222-2222-4222-8222-222222222222"),
      ).toBe(true);
      expect(
        state.orphanMessages.has("11111111-1111-4111-8111-111111111111"),
      ).toBe(true);
