...
export const MetadataSchema = z.object({
  ...
  nastechHomeDir: z.string().optional(), // NasTech configuration directory
   ...
   * `parentSessionId` is the NasTech session this one was branched from.
...
export const MachineMetadataSchema = z.object({
  ...
  nastechHomeDir: z.string(), // Directory for NasTech auth, settings, logs (usually .nastech/ or .nastech-dev/)
  ...
  shutdownSource: z
    .enum(["nastech-app", "nastech-cli", "os-signal", "unknown"])
    .optional(),
  cliAvailability: z
    .object({
      claude: z.boolean(),
