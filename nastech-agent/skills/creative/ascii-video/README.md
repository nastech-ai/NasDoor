...
Built for [NasTech Agent](https://github.com/nastech-ai/NasTech-Agent). Usable in any coding agent. Canonical source lives here; synced to [`nastech-ai/NasTech-Agent/skills/creative/ascii-video`](https://github.com/nastech-ai/NasTech-Agent/tree/main/skills/creative/ascii-video) via PR.
