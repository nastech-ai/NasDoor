...
SKIP_FILE_NAMES: frozenset = frozenset({
    ...
    "nastech-smoke-test",
    # Audit + publishing tools that MUST reference upstream names as data/patterns
    ...
    # Documentation that intentionally lists forbidden strings as a reference table
    "AGENTS.md",               # mandatory agent rules — contains "never write X" examples
    "CHANGELOG.md",            # release history — names deleted/replaced files by their old names
})
