...
Control the user's Spotify account via the NasTech Spotify toolset (7 tools). Setup guide: https://docs.nastech-agent.workers.dev/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `nastech auth spotify` again.
