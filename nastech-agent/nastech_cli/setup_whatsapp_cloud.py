...
Entry point: ``nastech whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``nastech_cli/main.py``).
...
NasTech gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("─" * 50)
    print()
    print("  NasTech needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the NasTech gateway in another terminal:")
    print("         nastech gateway")
    print()
    ...
    print()
    print("  Docs: https://nastech-agent.nastechai.com/docs/user-guide/")
