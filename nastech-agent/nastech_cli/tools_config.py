...
TOOL_CATEGORIES = {
    ...
    "browser": {
        ...
        #     billed via Nous subscription (requires_nastech_auth +
        ...
        "providers": [
            {
                ...
                "env_vars": [
                    ...
                    # extra keys required. NASTECH_CUA_DRIVER_VERSION is an
...
def _visible_providers(
    ...
    *,
    ...
    Nous-managed Tool Gateway rows (``managed_nastech_feature``) are always
