...
Visual styling mirrors the NasTech design system (the
``@nastech-ai/ui`` package the React dashboard uses): the same
...
``tests/nastech_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<style>
  /* Brand fonts shipped by @nastech-ai/ui — same files the SPA loads. */
  @font-face {{
