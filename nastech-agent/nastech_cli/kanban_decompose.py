...
Invoked by ``nastech kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the NasTech Agent board.
...
def _profile_author() -> str:
    """Mirror of ``nastech_cli.kanban._profile_author``."""
    return (
