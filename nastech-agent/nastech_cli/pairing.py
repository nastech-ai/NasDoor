...
Usage:
    nastech pairing list              # Show all pending + approved users
    nastech pairing approve <platform> <code>  # Approve a pairing code
    nastech pairing revoke <platform> <user_id> # Revoke user access
...
def pairing_command(args):
    ...
    if action == "list":
        ...
        print("Usage: nastech pairing {list|approve|revoke|clear-pending}")
        print("Run 'nastech pairing --help' for details.")
