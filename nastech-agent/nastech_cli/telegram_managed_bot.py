...
DEFAULT_API_URL = "https://setup.nastech-agent.nastechai.com"
...
def generate_bot_username(profile_name: Optional[str] = None) -> str:
    """Generate a secure suggested bot username like ``nastech_<slug>_bot``.
    ...
    """
    _ = profile_name
    return f"nastech_{generate_username_slug()}_bot"
