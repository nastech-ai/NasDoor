...
Config: ~/.nastech/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.nastech/feishu_comment_pairing.json.
"""
...
RULES_FILE = get_nastech_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_nastech_home() / "feishu_comment_pairing.json"
