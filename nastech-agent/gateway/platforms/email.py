"""
Email platform adapter for the NasTech gateway.

Allows users to interact with NasTech by sending emails.
...
def _send_imap_id(imap: "imaplib.IMAP4") -> None:
    ...
    try:
        ...
        imap.xatom(
            ...
            '"vendor" "NasTech" '
            '"support-email" "noreply@nastech.com")',
        )
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "NasTech Agent")
        ...
        msg_id = f"<nastech-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
