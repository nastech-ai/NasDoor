...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "nastech").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'nastech memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], nastech_home: str) -> None:
