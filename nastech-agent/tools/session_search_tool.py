...
the get_anchored_view / get_messages_around primitives in nastech_state.
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from nastech_state import DEFAULT_DB_PATH
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another NasTech profile's database "
