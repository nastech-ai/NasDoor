...
can break on OS updates. Pin the installed version via `NASTECH_CUA_DRIVER_
...
def cua_driver_binary_available() -> bool:
    """True if `cua-driver` is on $PATH or NASTECH_CUA_DRIVER_CMD resolves."""
...
def cua_driver_install_hint() -> str:
    return (
        ...
        "Or run `nastech tools` and enable the Computer Use toolset to install it automatically."
    )
