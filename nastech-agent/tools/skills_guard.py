...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.nastech/\.env|\~/\.nastech/\.env',
     "nastech_env_access", "critical", "exfiltration",
     "directly references NasTech secrets file"),
    ...
    (r'\.nastech/config\.yaml|\.nastech/SOUL\.md',
     "nastech_config_mod", "critical", "persistence",
     "references NasTech configuration files directly"),
